...
public class FormationController implements Initializable {
	...
	public ListProperty<Formation> formacionProperty() {
		return this.formacion;
	}

	public ObservableList<Formation> getFormacion() {
		return this.formacionProperty().get();
	}

	public void setFormacion(final ObservableList<Formation> formacion) {
